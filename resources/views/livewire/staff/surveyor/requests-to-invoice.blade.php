    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h5 class="m-0">Connections to Invoice</h5>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
                        ...
                        <thead class="text-info text-center">
                          ...
                          <tbody>
                            @forelse($requests as $request)
                                <tr>
                                    <td>{{ $request->surveyorApprovedDate }}</td>
                                    <td>{{ $request->fullName }}</td>
                                    <td>{{ $request->jobTitle }}</td>
                                    <td>{{ $request->distance }}m<sup>3</sup></td>
                                    <td>{{ $request->cordX }}</td>
                                    <td>{{ $request->cordY }}</td>
                                    <td>
                                        <a href="{{ route('surveyor.createinvoice', $request)}}"><i class="nav-icon fa fa-edit text-primary mr-2"></i></a>
                                    </td>
                                </tr>
                            @empty
                              <tr>
                                <td colspan="7" class="text-center p-4">
                                    No connection request ready for invoice creation!
                                </td>
                              </tr>
                            @endforelse
