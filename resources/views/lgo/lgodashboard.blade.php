...
<head>
  ...
  <link rel="icon" href="{{ asset('backend/dist/img/AdminLTELogo.jpeg') }}">
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2023 <a href="https://www.dawasa.go.tz/en">DAWASA</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
